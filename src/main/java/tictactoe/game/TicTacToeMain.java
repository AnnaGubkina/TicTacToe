...
import tictactoe.gameclasses.*;
import tictactoe.parsers.*;
...
public class TicTacToeMain {
    ...
    public static void playStart(String player1, String player2, HashMap<String, Integer> players) {
        ...
        while (true) {
            System.out.println("Ход " + (isCrossTurn ? "крестиком " : "ноликом ") + ",введите две цифры(от 1 до 3х) -координаты поля(например 12)");
            printField(field);
            String input = scanner.nextLine(); //32
            if (input.equals("11") || input.equals("12") || input.equals("13") || input.equals("21") ||
                    input.equals("22") || input.equals("23") || input.equals("31") || input.equals("32") || input.equals("33")) {
